package hackerrank1.java.com.vaquar.hackerrank;
 ...
 * located on the first floor of a building, that has a unique pricing policy. There are N stairs leading to the shop. A numbered ball is placed on
 ...
 * 
 * Input Format The first line of the input contains an integer N, the number of steps. N lines follow, which are the numbers written on the ball on
 * each step.
 * 
