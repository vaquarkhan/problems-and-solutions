 ...
 * 
 * Output format: If itâ€™s possible for Dorsey to escape, print the maximum profit he can enjoy, otherwise print â€œGot caught!â€� (quotes are for clarity)
 * 
 * Constraints 1 <= X <= 5000 1 <= N <= 106 all viâ€™s and aiâ€™s are less than or equal to 106 and greater than 0.
 * 
 * 
